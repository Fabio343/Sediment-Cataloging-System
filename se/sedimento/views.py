...
def lista_continente(request):
    ...
    return render_to_response(
        "sedimento/lista_continente.html",{'amostras':amostras, 'user': user} )

def lista_país(request):
    user = request.user
    amostras=Amostra.objects.all()
    return render_to_response(
        "sedimento/lista_país.html",{'amostras':amostras, 'user': user} )

def lista_estado(request):
    user = request.user
    amostras=Amostra.objects.all()
    return render_to_response(
        "sedimento/lista_estado.html",{'amostras':amostras, 'user': user} )

def lista_cidade(request):
    user = request.user
    amostras=Amostra.objects.all()
    return render_to_response(
        "sedimento/lista_cidade.html",{'amostras':amostras, 'user': user} )

def lista_ambiente(request):
    user = request.user
    amostras=Amostra.objects.all()
    return render_to_response(
        "sedimento/lista_ambiente.html",{'amostras':amostras, 'user': user} )

def lista_clima(request):
    user = request.user
    amostras=Amostra.objects.all()
    return render_to_response(
        "sedimento/lista_clima.html",{'amostras':amostras, 'user': user} )
########################################################################################################################
...
def create_amostra(request):
    if not request.user.is_authenticated():
        return render(request, 'sedimento/login.html')
    else:
        ...
        if form.is_valid():
            ...
            amostra.save()
            return render(request, 'sedimento/detail.html', {'amostra': amostra})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/amostra_form.html', context)
...
def delete_amostra(request, amostra_id):
    if not request.user.is_authenticated():
     ...
     amostra.delete()
     return render(request, 'sedimento/delete.html', {'amostras': amostras})


def detail(request, amostra_id):
        user = request.user
        amostra = get_object_or_404(Amostra, pk=amostra_id)
        return render(request, 'sedimento/detail.html', {'amostra': amostra, 'user': user})
...
def create_continente(request):
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            continente.save()
            return render(request, 'sedimento/detail.html', {continente: continente})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/continente_form.html', context)
...
def create_cidade(request):
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            cidade.save()
            return render(request, 'sedimento/detail.html', {cidade: cidade})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/cidade_form.html', context)
...
def create_estado(request):
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            estado.save()
            return render(request, 'sedimento/detail.html', {estado: estado})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/estado_form.html', context)
...
def create_país(request):
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            país.save()
            return render(request, 'sedimento/detail.html', {país: país})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/país_form.html', context)
...
def create_ambiente(request):
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            ambiente.save()
            return render(request, 'sedimento/detail.html', {ambiente: ambiente})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/ambiente_form.html', context)
...
def create_clima(request):
    if not request.user.is_authenticated():
        ...
        if form.is_valid():
            ...
            clima.save()
            return render(request, 'sedimento/detail.html', {clima: clima})
        context = {
            "form": form,
        }
        return render(request, 'sedimento/clima_form.html', context)
...
def index(request):
        ...
        if query:
            ...
            return render(request, 'sedimento/pesquisa.html', {
                'amostras': amostras,
                'paíss': país_results,
            ...
            return render(request, 'sedimento/index.html', {'amostras': amostras})
...
def amostra(request):
        ...
        if query:
            ...
            return render(request, 'sedimento/amostra.html', {'amostras': amostras})
...
class UserFormView(View):
    form_class=UserForm
    template_name='sedimento/register_form.html'
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                if user.is_active:
                    login(request,user)
                return redirect('sedimento:index')
        return render(request, self.template_name, {'form': form})
...
def logout_user(request):
    ...
    return render(request, 'sedimento/logout.html', context)
...
def inicial(request):
    ...
    return render(request, 'sedimento/inicial.html', context)
    ...
    if request.method == "POST":
        ...
        if user is not None:
            if user.is_active:
                ...
                return render(request, 'sedimento/inicial.html', {'amostras': amostras})
            else:
                return render(request, 'sedimento/login.html', {'error_message': 'Sua conta foi desativada'})
        else:
                return render(request, 'sedimento/login.html', {'error_message': ' Login Invalido '})
    return render(request, 'sedimento/login.html')
...
def register(request):
    ...
    return render(request, 'sedimento/register_form.html', context)
...
def contato(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            template = get_template('sedimento/contato.html')
            context = Context({
                'Nome': Nome,
                'Email': Email,
                'Mensagem': Mensagem,
    ...
    return render(request, 'sedimento/contato.html', {'form': form_class, })
...
def adicionar(request):
    ...
    return render(request, 'sedimento/adicionar.html', context)
...
def agradecimentos(request):
    ...
    return render(request, 'sedimento/agradecimentos.html', context)
...
def amostras(request, filter_by):
        try:
            ...
            users_amostras = []
        return render(request, 'sedimento/amostras.html', {
...
def continentes(request, filter_by):
    ...
    return render(request, 'sedimento/continentes.html', {
...
def paíss(request, filter_by):
    try:
        ...
        users_paíss = []
    return render(request, 'sedimento/paíss.html', {
...
def estados(request, filter_by):
    try:
        ...
        users_estados = []
    return render(request, 'sedimento/estados.html', {
...
def cidades(request, filter_by):
    try:
        ...
        users_cidades = []
    return render(request, 'sedimento/cidades.html', {
...
def climas(request, filter_by):
    try:
        ...
        users_climas = []
    return render(request, 'sedimento/climas.html', {
...
def ambientes(request, filter_by):
    try:
        ...
        users_ambientes = []
    return render(request, 'sedimento/ambientes.html', {
...
def edit(request):
    ...
    return render(request, 'sedimento/edit.html', context)
...
def change_password(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse('sedimento/login.html'))
        else:
            return redirect(reverse('sedimento/change_password'))
    else:
        form = PasswordChangeForm(user=request.user)

        args = {'form': form}
        return render(request, 'sedimento/change_password.html', args)
...
def view_profile(request):
    ...
    return render(request, 'sedimento/profile.html', args)
...
def edit_profile(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect(reverse('sedimento:view_profile'))
    else:
        form = EditProfileForm(instance=request.user)
        args = {'form': form}
        return render(request, 'sedimento/edit_profile.html', args)
...
def amostra_edit(request,amostra_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            amostra = form.save(commit=False)
            amostra.save()
            return redirect(reverse('sedimento:inicial'))

    else:
        form = amostraForm(instance=amostra)
    return render(request, 'sedimento/amostra_edit.html', {'form': form})
########################################################################################################################
########################################################################################################################
def continente_edit(request,continente_id):
    ...
    return render(request, 'sedimento/continente_edit.html', {'form': form})
...
def país_edit(request,país_id):
    ...
    return render(request, 'sedimento/país_edit.html', {'form': form})
...
def estado_edit(request,estado_id):
    ...
    return render(request, 'sedimento/estado_edit.html', {'form': form})
...
def cidade_edit(request,cidade_id):
    ...
    return render(request, 'sedimento/cidade_edit.html', {'form': form})
...
def clima_edit(request,clima_id):
    ...
    return render(request, 'sedimento/clima_edit.html', {'form': form})
...
def ambiente_edit(request,ambiente_id):
    ...
    return render(request, 'sedimento/ambiente_edit.html', {'form': form})
...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            template =  get_template('sedimento/contac_template.txt')
            context = Context({
                'Nome': Nome,
                'Email': Email,
                'Mensagem': Mensagem,
            ...
            return render(request, 'sedimento/inicial.html', context)
    return render(request, 'sedimento/contact.html', { 'form': form_class, })
