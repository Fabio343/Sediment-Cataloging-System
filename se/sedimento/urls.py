...
urlpatterns = [
   ...
   # se refere a detalhes gerais e apresentação inicial do site /
    ...
    url(r'^reset-password/$', password_reset,
        {'template_name': 'sedimento/reset_password.html', 'post_reset_redirect': 'sedimento:password_reset_done',
         'email_template_name': 'sedimento/reset_password_email.html'}, name='reset_password'),

    url(r'^reset-password/done/$', password_reset_done, {'template_name': 'sedimento/reset_password_done.html'},
        name='password_reset_done'),

    url(r'^reset-password/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', password_reset_confirm,
        {'template_name': 'sedimento/reset_password_confirm.html',
         'post_reset_redirect': 'sedimento:password_reset_complete'}, name='password_reset_confirm'),

    url(r'^reset-password/complete/$', password_reset_complete,
        {'template_name': 'sedimento/reset_password_complete.html'}, name='password_reset_complete'),
