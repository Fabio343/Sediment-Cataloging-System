...
urlpatterns = [
    ...
    # se refere a uma em especifico/
    url(r'^(?P<pk>[0-9]+)/$', views.DetailView2.as_view(), name='detail'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<pk>[0-9]+)/$', views.DetailView3.as_view(), name='detail'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<pk>[0-9]+)/$', views.DetailView4.as_view(), name='detail'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<pk>[0-9]+)/$', views.DetailView5.as_view(), name='detail'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<pk>[0-9]+)/$', views.DetailView6.as_view(), name='detail'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<pk>[0-9]+)/$', views.DetailView7.as_view(), name='detail'),
