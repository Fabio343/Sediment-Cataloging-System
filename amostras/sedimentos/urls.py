...
urlpatterns = [
    ...
    # se refere a uma em especifico/
    url(r'^(?P<continente_id>[0-9]+)/$', views.contd, name='contd'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<cidade_id>[0-9]+)/$', views.detail5, name='detail5'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<estado_id>[0-9]+)/$', views.detail4, name='detail4'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<país_id>[0-9]+)/$', views.detail3, name='detail3'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<ambiente_id>[0-9]+)/$', views.detail6, name='detail6'),
    ...
    # se refere a uma em especifico/
    url(r'^(?P<clima_id>[0-9]+)/$', views.detail7, name='detail7'),
