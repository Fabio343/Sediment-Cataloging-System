...
urlpatterns = [
    ...
    url(r'^search/$', FilterView.as_view(filterset_class=UserFilter,
        template_name='amostras/grupo.html'), name='search'),

    url(r'^amostraFilter/$', FilterView.as_view(filterset_class=amostraFilter,   template_name='amostras/grupo.html'), name='amostraFilter'),
